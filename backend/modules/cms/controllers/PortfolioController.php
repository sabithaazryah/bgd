...
class PortfolioController extends Controller {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->SetValues->Attributes($model)) {
            ...
            if ($model->validate() && $model->save()) {
                ...
                Yii::$app->session->setFlash('success', "Portfolio added successfully");
    ...
    public function Upload($image, $model) {
        if (!empty($image)) {
            $path = Yii::$app->basePath . '/../images/portfolio';
            FileHelper::createDirectory($path, $mode = 0775, $recursive = true);
            $name = 'portfolio' . $model->id;
    ...
    public function actionDelete($id) {
        $model = $this->findModel($id);
        $path = Yii::$app->basePath . '/../images/portfolio/portfolio' . $id . '.' . $model->image;
