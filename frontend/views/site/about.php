    ...
    <div class="sec1">
       <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="float_img">
              <img src="assets/images/story_float.jpg" class="img-fluid" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-5 lft_sec">
          <img src="assets/images/photo_frame.png" alt="" class="img_fluid wow animated fadeInDown img1">
          <img src="assets/images/flwrvase.png" alt="" class="img_fluid wow animated fadeInLeft img2">
        </div>
